...
-- Membuang struktur basisdata untuk 231017
DROP DATABASE IF EXISTS `231017`;
CREATE DATABASE IF NOT EXISTS `231017` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `231017`;

-- membuang struktur untuk table 231017.wp_actionscheduler_actions
...
-- membuang struktur untuk table 231017.wp_actionscheduler_claims
...
-- membuang struktur untuk table 231017.wp_actionscheduler_groups
...
-- membuang struktur untuk table 231017.wp_actionscheduler_logs
...
-- membuang struktur untuk table 231017.wp_commentmeta
...
-- membuang struktur untuk table 231017.wp_comments
...
-- membuang struktur untuk table 231017.wp_dokan_announcement
DROP TABLE IF EXISTS `wp_dokan_announcement`;
CREATE TABLE IF NOT EXISTS `wp_dokan_announcement` (
...
-- membuang struktur untuk table 231017.wp_dokan_orders
...
-- membuang struktur untuk table 231017.wp_dokan_order_stats
DROP TABLE IF EXISTS `wp_dokan_order_stats`;
CREATE TABLE IF NOT EXISTS `wp_dokan_order_stats` (
...
-- membuang struktur untuk table 231017.wp_dokan_refund
DROP TABLE IF EXISTS `wp_dokan_refund`;
CREATE TABLE IF NOT EXISTS `wp_dokan_refund` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `order_id` bigint unsigned NOT NULL,
...
-- membuang struktur untuk table 231017.wp_dokan_reverse_withdrawal
DROP TABLE IF EXISTS `wp_dokan_reverse_withdrawal`;
CREATE TABLE IF NOT EXISTS `wp_dokan_reverse_withdrawal` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
...
-- membuang struktur untuk table 231017.wp_dokan_vendor_balance
...
-- membuang struktur untuk table 231017.wp_dokan_withdraw
DROP TABLE IF EXISTS `wp_dokan_withdraw`;
CREATE TABLE IF NOT EXISTS `wp_dokan_withdraw` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `user_id` bigint unsigned NOT NULL,
...
-- membuang struktur untuk table 231017.wp_e_events
...
-- membuang struktur untuk table 231017.wp_hurrytimer_evergreen
DROP TABLE IF EXISTS `wp_hurrytimer_evergreen`;
CREATE TABLE IF NOT EXISTS `wp_hurrytimer_evergreen` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `countdown_id` bigint unsigned NOT NULL,
  `client_ip_address` varchar(50) COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `expired` tinyint unsigned DEFAULT NULL,
  `client_expires_at` bigint unsigned NOT NULL,
  `reset_token` varchar(20) COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
...
-- membuang struktur untuk table 231017.wp_links
...
-- membuang struktur untuk table 231017.wp_options
...
) ENGINE=InnoDB AUTO_INCREMENT=4547 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci;

-- Pengeluaran data tidak dipilih.

-- membuang struktur untuk table 231017.wp_postmeta
...
CREATE TABLE IF NOT EXISTS `wp_postmeta` (
  ...
  KEY `post_id` (`post_id`),
  KEY `meta_key` (`meta_key`(191))
) ENGINE=InnoDB AUTO_INCREMENT=6008 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci;

-- Pengeluaran data tidak dipilih.

-- membuang struktur untuk table 231017.wp_posts
...
) ENGINE=InnoDB AUTO_INCREMENT=4332 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci;

-- Pengeluaran data tidak dipilih.

-- membuang struktur untuk table 231017.wp_revslider_css
...
CREATE TABLE IF NOT EXISTS `wp_revslider_css` (
  ...
  `hover` longtext COLLATE utf8mb4_general_ci,
  `advanced` longtext COLLATE utf8mb4_general_ci,
  `params` longtext COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`id`),
...
-- membuang struktur untuk table 231017.wp_revslider_layer_animations
...
-- membuang struktur untuk table 231017.wp_revslider_navigations
DROP TABLE IF EXISTS `wp_revslider_navigations`;
CREATE TABLE IF NOT EXISTS `wp_revslider_navigations` (
  `id` int NOT NULL AUTO_INCREMENT,
  `name` varchar(191) COLLATE utf8mb4_general_ci NOT NULL,
  `handle` varchar(191) COLLATE utf8mb4_general_ci NOT NULL,
  `type` varchar(191) COLLATE utf8mb4_general_ci NOT NULL,
  `css` longtext COLLATE utf8mb4_general_ci NOT NULL,
  `markup` longtext COLLATE utf8mb4_general_ci NOT NULL,
  `settings` longtext COLLATE utf8mb4_general_ci,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
-- membuang struktur untuk table 231017.wp_revslider_sliders
...
CREATE TABLE IF NOT EXISTS `wp_revslider_sliders` (
  ...
  `alias` tinytext COLLATE utf8mb4_general_ci,
  `params` longtext COLLATE utf8mb4_general_ci NOT NULL,
  `settings` text COLLATE utf8mb4_general_ci,
...
-- membuang struktur untuk table 231017.wp_revslider_sliders7
...
-- membuang struktur untuk table 231017.wp_revslider_slides
...
CREATE TABLE IF NOT EXISTS `wp_revslider_slides` (
  ...
  `params` longtext COLLATE utf8mb4_general_ci NOT NULL,
  `layers` longtext COLLATE utf8mb4_general_ci NOT NULL,
...
-- membuang struktur untuk table 231017.wp_revslider_slides7
...
CREATE TABLE IF NOT EXISTS `wp_revslider_slides7` (
  ...
  `layers` longtext COLLATE utf8mb4_general_ci NOT NULL,
  `settings` text COLLATE utf8mb4_general_ci NOT NULL,
  `static` varchar(191) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  PRIMARY KEY (`id`),
  KEY `slider_id_index` (`slider_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
-- membuang struktur untuk table 231017.wp_revslider_static_slides
...
-- membuang struktur untuk table 231017.wp_termmeta
...
-- membuang struktur untuk table 231017.wp_terms
...
-- membuang struktur untuk table 231017.wp_term_relationships
...
-- membuang struktur untuk table 231017.wp_term_taxonomy
...
-- membuang struktur untuk table 231017.wp_tinvwl_analytics
DROP TABLE IF EXISTS `wp_tinvwl_analytics`;
CREATE TABLE IF NOT EXISTS `wp_tinvwl_analytics` (
...
-- membuang struktur untuk table 231017.wp_tinvwl_items
DROP TABLE IF EXISTS `wp_tinvwl_items`;
CREATE TABLE IF NOT EXISTS `wp_tinvwl_items` (
  `ID` bigint NOT NULL AUTO_INCREMENT,
  `wishlist_id` bigint NOT NULL DEFAULT '0',
  `product_id` bigint NOT NULL DEFAULT '0',
  `variation_id` bigint NOT NULL DEFAULT '0',
...
-- membuang struktur untuk table 231017.wp_tinvwl_lists
DROP TABLE IF EXISTS `wp_tinvwl_lists`;
CREATE TABLE IF NOT EXISTS `wp_tinvwl_lists` (
  `ID` bigint NOT NULL AUTO_INCREMENT,
  `author` bigint NOT NULL DEFAULT '0',
  `date` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `title` text,
...
-- membuang struktur untuk table 231017.wp_usermeta
...
-- membuang struktur untuk table 231017.wp_users
DROP TABLE IF EXISTS `wp_users`;
CREATE TABLE IF NOT EXISTS `wp_users` (
  `ID` bigint unsigned NOT NULL AUTO_INCREMENT,
  `user_login` varchar(60) COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT '',
  `user_pass` varchar(255) COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT '',
  `user_nicename` varchar(250) COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT '',
...
-- membuang struktur untuk table 231017.wp_wcboost_wishlists
DROP TABLE IF EXISTS `wp_wcboost_wishlists`;
CREATE TABLE IF NOT EXISTS `wp_wcboost_wishlists` (
...
-- membuang struktur untuk table 231017.wp_wcboost_wishlist_items
DROP TABLE IF EXISTS `wp_wcboost_wishlist_items`;
CREATE TABLE IF NOT EXISTS `wp_wcboost_wishlist_items` (
...
-- membuang struktur untuk table 231017.wp_wcfm_daily_analysis
DROP TABLE IF EXISTS `wp_wcfm_daily_analysis`;
CREATE TABLE IF NOT EXISTS `wp_wcfm_daily_analysis` (
  `ID` bigint NOT NULL AUTO_INCREMENT,
...
-- membuang struktur untuk table 231017.wp_wcfm_detailed_analysis
DROP TABLE IF EXISTS `wp_wcfm_detailed_analysis`;
CREATE TABLE IF NOT EXISTS `wp_wcfm_detailed_analysis` (
  `ID` bigint NOT NULL AUTO_INCREMENT,
  `is_shop` tinyint(1) NOT NULL DEFAULT '0',
  `is_store` tinyint(1) NOT NULL DEFAULT '0',
  `is_product` tinyint(1) NOT NULL DEFAULT '0',
...
-- membuang struktur untuk table 231017.wp_wcfm_enquiries
DROP TABLE IF EXISTS `wp_wcfm_enquiries`;
CREATE TABLE IF NOT EXISTS `wp_wcfm_enquiries` (
  `ID` bigint NOT NULL AUTO_INCREMENT,
  ...
  `reply_by` bigint NOT NULL DEFAULT '0',
...
-- membuang struktur untuk table 231017.wp_wcfm_enquiries_meta
DROP TABLE IF EXISTS `wp_wcfm_enquiries_meta`;
CREATE TABLE IF NOT EXISTS `wp_wcfm_enquiries_meta` (
  `ID` bigint NOT NULL AUTO_INCREMENT,
  `enquiry_id` bigint NOT NULL DEFAULT '0',
...
-- membuang struktur untuk table 231017.wp_wcfm_enquiries_response
DROP TABLE IF EXISTS `wp_wcfm_enquiries_response`;
CREATE TABLE IF NOT EXISTS `wp_wcfm_enquiries_response` (
  `ID` bigint NOT NULL AUTO_INCREMENT,
  `enquiry_id` bigint NOT NULL DEFAULT '0',
  `product_id` bigint NOT NULL DEFAULT '0',
  `vendor_id` bigint NOT NULL DEFAULT '0',
...
-- membuang struktur untuk table 231017.wp_wcfm_enquiries_response_meta
DROP TABLE IF EXISTS `wp_wcfm_enquiries_response_meta`;
CREATE TABLE IF NOT EXISTS `wp_wcfm_enquiries_response_meta` (
  `ID` bigint NOT NULL AUTO_INCREMENT,
  `enquiry_response_id` bigint NOT NULL DEFAULT '0',
  `key` varchar(200) COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `value` longtext COLLATE utf8mb4_unicode_520_ci NOT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci;
...
-- membuang struktur untuk table 231017.wp_wcfm_fbc_chat_rows
DROP TABLE IF EXISTS `wp_wcfm_fbc_chat_rows`;
CREATE TABLE IF NOT EXISTS `wp_wcfm_fbc_chat_rows` (
  ...
  `msg_time` bigint unsigned NOT NULL,
  UNIQUE KEY `message_id` (`message_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci;

-- Pengeluaran data tidak dipilih.

-- membuang struktur untuk table 231017.wp_wcfm_fbc_chat_sessions
DROP TABLE IF EXISTS `wp_wcfm_fbc_chat_sessions`;
CREATE TABLE IF NOT EXISTS `wp_wcfm_fbc_chat_sessions` (
...
-- membuang struktur untuk table 231017.wp_wcfm_fbc_chat_visitors
DROP TABLE IF EXISTS `wp_wcfm_fbc_chat_visitors`;
CREATE TABLE IF NOT EXISTS `wp_wcfm_fbc_chat_visitors` (
  `user_id` varchar(30) COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT '',
  ...
  `last_online` bigint unsigned DEFAULT NULL,
...
-- membuang struktur untuk table 231017.wp_wcfm_fbc_offline_messages
DROP TABLE IF EXISTS `wp_wcfm_fbc_offline_messages`;
CREATE TABLE IF NOT EXISTS `wp_wcfm_fbc_offline_messages` (
  `id` int NOT NULL AUTO_INCREMENT,
...
-- membuang struktur untuk table 231017.wp_wcfm_following_followers
DROP TABLE IF EXISTS `wp_wcfm_following_followers`;
CREATE TABLE IF NOT EXISTS `wp_wcfm_following_followers` (
  `ID` bigint NOT NULL AUTO_INCREMENT,
...
-- membuang struktur untuk table 231017.wp_wcfm_marketplace_orders
...
CREATE TABLE IF NOT EXISTS `wp_wcfm_marketplace_orders` (
  ...
  `refunded_id` bigint NOT NULL DEFAULT '0',
...
-- membuang struktur untuk table 231017.wp_wcfm_marketplace_orders_meta
DROP TABLE IF EXISTS `wp_wcfm_marketplace_orders_meta`;
CREATE TABLE IF NOT EXISTS `wp_wcfm_marketplace_orders_meta` (
  `ID` bigint NOT NULL AUTO_INCREMENT,
  `order_commission_id` bigint NOT NULL DEFAULT '0',
  `key` varchar(200) COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `value` longtext COLLATE utf8mb4_unicode_520_ci NOT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci;
...
-- membuang struktur untuk table 231017.wp_wcfm_marketplace_product_multivendor
DROP TABLE IF EXISTS `wp_wcfm_marketplace_product_multivendor`;
CREATE TABLE IF NOT EXISTS `wp_wcfm_marketplace_product_multivendor` (
  `ID` bigint NOT NULL AUTO_INCREMENT,
  `product_id` bigint NOT NULL,
...
-- membuang struktur untuk table 231017.wp_wcfm_marketplace_refund_request
DROP TABLE IF EXISTS `wp_wcfm_marketplace_refund_request`;
CREATE TABLE IF NOT EXISTS `wp_wcfm_marketplace_refund_request` (
  `ID` bigint NOT NULL AUTO_INCREMENT,
  `vendor_id` bigint NOT NULL,
...
-- membuang struktur untuk table 231017.wp_wcfm_marketplace_refund_request_meta
DROP TABLE IF EXISTS `wp_wcfm_marketplace_refund_request_meta`;
CREATE TABLE IF NOT EXISTS `wp_wcfm_marketplace_refund_request_meta` (
  `ID` bigint NOT NULL AUTO_INCREMENT,
...
-- membuang struktur untuk table 231017.wp_wcfm_marketplace_reverse_withdrawal
DROP TABLE IF EXISTS `wp_wcfm_marketplace_reverse_withdrawal`;
CREATE TABLE IF NOT EXISTS `wp_wcfm_marketplace_reverse_withdrawal` (
  `ID` bigint NOT NULL AUTO_INCREMENT,
  `vendor_id` bigint NOT NULL,
  `order_id` bigint NOT NULL,
  `commission_id` bigint NOT NULL,
...
-- membuang struktur untuk table 231017.wp_wcfm_marketplace_reverse_withdrawal_meta
DROP TABLE IF EXISTS `wp_wcfm_marketplace_reverse_withdrawal_meta`;
CREATE TABLE IF NOT EXISTS `wp_wcfm_marketplace_reverse_withdrawal_meta` (
  `ID` bigint NOT NULL AUTO_INCREMENT,
...
-- membuang struktur untuk table 231017.wp_wcfm_marketplace_reviews
DROP TABLE IF EXISTS `wp_wcfm_marketplace_reviews`;
CREATE TABLE IF NOT EXISTS `wp_wcfm_marketplace_reviews` (
  `ID` bigint NOT NULL AUTO_INCREMENT,
  `vendor_id` bigint NOT NULL,
...
-- membuang struktur untuk table 231017.wp_wcfm_marketplace_reviews_response
DROP TABLE IF EXISTS `wp_wcfm_marketplace_reviews_response`;
CREATE TABLE IF NOT EXISTS `wp_wcfm_marketplace_reviews_response` (
  `ID` bigint NOT NULL AUTO_INCREMENT,
...
-- membuang struktur untuk table 231017.wp_wcfm_marketplace_reviews_response_meta
DROP TABLE IF EXISTS `wp_wcfm_marketplace_reviews_response_meta`;
CREATE TABLE IF NOT EXISTS `wp_wcfm_marketplace_reviews_response_meta` (
  `ID` bigint NOT NULL AUTO_INCREMENT,
...
-- membuang struktur untuk table 231017.wp_wcfm_marketplace_review_rating_meta
DROP TABLE IF EXISTS `wp_wcfm_marketplace_review_rating_meta`;
CREATE TABLE IF NOT EXISTS `wp_wcfm_marketplace_review_rating_meta` (
  `ID` bigint NOT NULL AUTO_INCREMENT,
...
-- membuang struktur untuk table 231017.wp_wcfm_marketplace_shipping_zone_locations
DROP TABLE IF EXISTS `wp_wcfm_marketplace_shipping_zone_locations`;
CREATE TABLE IF NOT EXISTS `wp_wcfm_marketplace_shipping_zone_locations` (
...
-- membuang struktur untuk table 231017.wp_wcfm_marketplace_shipping_zone_methods
DROP TABLE IF EXISTS `wp_wcfm_marketplace_shipping_zone_methods`;
CREATE TABLE IF NOT EXISTS `wp_wcfm_marketplace_shipping_zone_methods` (
...
-- membuang struktur untuk table 231017.wp_wcfm_marketplace_store_taxonomies
DROP TABLE IF EXISTS `wp_wcfm_marketplace_store_taxonomies`;
CREATE TABLE IF NOT EXISTS `wp_wcfm_marketplace_store_taxonomies` (
  `ID` bigint NOT NULL AUTO_INCREMENT,
  `vendor_id` bigint NOT NULL,
  `product_id` bigint NOT NULL,
...
-- membuang struktur untuk table 231017.wp_wcfm_marketplace_vendor_ledger
DROP TABLE IF EXISTS `wp_wcfm_marketplace_vendor_ledger`;
CREATE TABLE IF NOT EXISTS `wp_wcfm_marketplace_vendor_ledger` (
  `ID` bigint NOT NULL AUTO_INCREMENT,
  `vendor_id` bigint NOT NULL,
...
-- membuang struktur untuk table 231017.wp_wcfm_marketplace_withdraw_request
DROP TABLE IF EXISTS `wp_wcfm_marketplace_withdraw_request`;
CREATE TABLE IF NOT EXISTS `wp_wcfm_marketplace_withdraw_request` (
  `ID` bigint NOT NULL AUTO_INCREMENT,
  `vendor_id` bigint NOT NULL,
...
-- membuang struktur untuk table 231017.wp_wcfm_marketplace_withdraw_request_meta
DROP TABLE IF EXISTS `wp_wcfm_marketplace_withdraw_request_meta`;
CREATE TABLE IF NOT EXISTS `wp_wcfm_marketplace_withdraw_request_meta` (
  `ID` bigint NOT NULL AUTO_INCREMENT,
...
-- membuang struktur untuk table 231017.wp_wcfm_membership_subscription
DROP TABLE IF EXISTS `wp_wcfm_membership_subscription`;
CREATE TABLE IF NOT EXISTS `wp_wcfm_membership_subscription` (
  `ID` bigint NOT NULL AUTO_INCREMENT,
  `vendor_id` bigint NOT NULL DEFAULT '0',
  `membership_id` bigint NOT NULL DEFAULT '0',
  `subscription_type` varchar(50) COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `subscription_amt` int NOT NULL DEFAULT '0',
...
-- membuang struktur untuk table 231017.wp_wcfm_messages
DROP TABLE IF EXISTS `wp_wcfm_messages`;
CREATE TABLE IF NOT EXISTS `wp_wcfm_messages` (
  `ID` bigint NOT NULL AUTO_INCREMENT,
  `message` longtext COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `author_id` bigint NOT NULL DEFAULT '0',
  `reply_to` bigint NOT NULL DEFAULT '0',
  `message_to` bigint NOT NULL DEFAULT '-1',
...
-- membuang struktur untuk table 231017.wp_wcfm_messages_modifier
DROP TABLE IF EXISTS `wp_wcfm_messages_modifier`;
CREATE TABLE IF NOT EXISTS `wp_wcfm_messages_modifier` (
  `ID` bigint NOT NULL AUTO_INCREMENT,
  `message` bigint NOT NULL DEFAULT '0',
  `is_read` tinyint(1) NOT NULL DEFAULT '0',
  `read_by` bigint NOT NULL DEFAULT '0',
  `read_on` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `is_trashed` tinyint(1) NOT NULL DEFAULT '0',
  `trashed_by` bigint NOT NULL DEFAULT '0',
...
-- membuang struktur untuk table 231017.wp_wcfm_messages_stat
DROP TABLE IF EXISTS `wp_wcfm_messages_stat`;
CREATE TABLE IF NOT EXISTS `wp_wcfm_messages_stat` (
  `ID` bigint NOT NULL AUTO_INCREMENT,
  `message` bigint NOT NULL DEFAULT '0',
  `is_liked` tinyint(1) NOT NULL DEFAULT '0',
  `liked_by` bigint NOT NULL DEFAULT '0',
  `liked_on` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `is_disliked` tinyint(1) NOT NULL DEFAULT '0',
  `disliked_by` bigint NOT NULL DEFAULT '0',
...
-- membuang struktur untuk table 231017.wp_wcfm_support
DROP TABLE IF EXISTS `wp_wcfm_support`;
CREATE TABLE IF NOT EXISTS `wp_wcfm_support` (
  `ID` bigint NOT NULL AUTO_INCREMENT,
...
-- membuang struktur untuk table 231017.wp_wcfm_support_meta
DROP TABLE IF EXISTS `wp_wcfm_support_meta`;
CREATE TABLE IF NOT EXISTS `wp_wcfm_support_meta` (
  `ID` bigint NOT NULL AUTO_INCREMENT,
...
-- membuang struktur untuk table 231017.wp_wcfm_support_response
DROP TABLE IF EXISTS `wp_wcfm_support_response`;
CREATE TABLE IF NOT EXISTS `wp_wcfm_support_response` (
  `ID` bigint NOT NULL AUTO_INCREMENT,
  `support_id` bigint NOT NULL DEFAULT '0',
  `order_id` bigint NOT NULL DEFAULT '0',
  `item_id` bigint NOT NULL DEFAULT '0',
...
-- membuang struktur untuk table 231017.wp_wcfm_support_response_meta
DROP TABLE IF EXISTS `wp_wcfm_support_response_meta`;
CREATE TABLE IF NOT EXISTS `wp_wcfm_support_response_meta` (
  `ID` bigint NOT NULL AUTO_INCREMENT,
  `support_response_id` bigint NOT NULL DEFAULT '0',
  `key` varchar(200) COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `value` longtext COLLATE utf8mb4_unicode_520_ci NOT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci;
...
-- membuang struktur untuk table 231017.wp_wc_admin_notes
...
-- membuang struktur untuk table 231017.wp_wc_admin_note_actions
...
CREATE TABLE IF NOT EXISTS `wp_wc_admin_note_actions` (
  ...
  PRIMARY KEY (`action_id`),
  KEY `note_id` (`note_id`)
) ENGINE=InnoDB AUTO_INCREMENT=5382 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci;

-- Pengeluaran data tidak dipilih.

-- membuang struktur untuk table 231017.wp_wc_category_lookup
...
-- membuang struktur untuk table 231017.wp_wc_customer_lookup
...
-- membuang struktur untuk table 231017.wp_wc_download_log
...
-- membuang struktur untuk table 231017.wp_wc_orders
...
-- membuang struktur untuk table 231017.wp_wc_orders_meta
...
-- membuang struktur untuk table 231017.wp_wc_order_addresses
...
-- membuang struktur untuk table 231017.wp_wc_order_coupon_lookup
...
-- membuang struktur untuk table 231017.wp_wc_order_operational_data
...
-- membuang struktur untuk table 231017.wp_wc_order_product_lookup
...
-- membuang struktur untuk table 231017.wp_wc_order_stats
...
-- membuang struktur untuk table 231017.wp_wc_order_tax_lookup
...
-- membuang struktur untuk table 231017.wp_wc_product_attributes_lookup
...
-- membuang struktur untuk table 231017.wp_wc_product_download_directories
...
-- membuang struktur untuk table 231017.wp_wc_product_meta_lookup
...
-- membuang struktur untuk table 231017.wp_wc_rate_limits
...
-- membuang struktur untuk table 231017.wp_wc_reserved_stock
...
-- membuang struktur untuk table 231017.wp_wc_tax_rate_classes
...
-- membuang struktur untuk table 231017.wp_wc_webhooks
...
-- membuang struktur untuk table 231017.wp_woocommerce_api_keys
...
-- membuang struktur untuk table 231017.wp_woocommerce_attribute_taxonomies
...
-- membuang struktur untuk table 231017.wp_woocommerce_downloadable_product_permissions
...
-- membuang struktur untuk table 231017.wp_woocommerce_log
...
-- membuang struktur untuk table 231017.wp_woocommerce_order_itemmeta
...
-- membuang struktur untuk table 231017.wp_woocommerce_order_items
...
-- membuang struktur untuk table 231017.wp_woocommerce_payment_tokenmeta
...
-- membuang struktur untuk table 231017.wp_woocommerce_payment_tokens
...
-- membuang struktur untuk table 231017.wp_woocommerce_sessions
...
-- membuang struktur untuk table 231017.wp_woocommerce_shipping_zones
...
-- membuang struktur untuk table 231017.wp_woocommerce_shipping_zone_locations
...
-- membuang struktur untuk table 231017.wp_woocommerce_shipping_zone_methods
...
-- membuang struktur untuk table 231017.wp_woocommerce_tax_rates
...
-- membuang struktur untuk table 231017.wp_woocommerce_tax_rate_locations
