...
wp_register_style('pgcontent_slider_splide_core', wcps_plugin_url . 'assets/admin/css/splide-core.min.css');
...
wp_localize_script('wcps-builder', 'wcps_editor_js', array('wcps_ajaxurl' => admin_url('admin-ajax.php'), '_wpnonce' => wp_create_nonce('wp_rest')));
