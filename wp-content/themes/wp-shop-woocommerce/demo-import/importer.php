	...
	public function get_step_done() { ?>
		...
		<div class="setup-finish">
			...
			<div class="finish-buttons">
				...
				<a href="<?php echo esc_url(site_url()); ?>" class="wz-btn-visit-site" target="_blank"><?php esc_html_e('Visit Your Site','wp-shop-woocommerce'); ?></a>
			</div>
			<div class="finish-buttons">
	...
	public function wp_shop_woocommerce_guide() {
		...
		<div class="wrapper-info get-stared-page-wrap">
			<div class="wrapper-info-content">
				<div class="buynow__">
					<h2><?php esc_html_e( 'Welcome to WP Shop Woocommerce', 'wp-shop-woocommerce' ); ?> <span class="version">Version: <?php echo esc_html($theme['Version']);?></span></h2>
