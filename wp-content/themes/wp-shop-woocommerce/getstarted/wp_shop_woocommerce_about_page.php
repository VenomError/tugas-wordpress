            ...
            <div class="getting-started-top-wrap clearfix">
                ...
                <div class="theme-steps-list">
                    <div class="theme-steps demo-import">
                        ...
                        <a target="_blank" class="button button-primary" href="<?php echo esc_url( admin_url( 'themes.php?page=wpshopwoocommerce-demoimport' ) ); ?>"><?php echo esc_html__( 'Click Here For Demo Import', 'wp-shop-woocommerce' ); ?></a>
                    </div>
                    <div class="getstart">
