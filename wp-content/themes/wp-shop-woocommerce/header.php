				...
				<div class="container">
					<div class="flex-row">
						<div class="nav-box-header-left">
							<?php if ( get_theme_mod('wp_shop_woocommerce_header_topbar_text') ) : ?><p><?php echo esc_html( get_theme_mod('wp_shop_woocommerce_header_topbar_text') ); ?></p><?php endif; ?>
						</div>
						<div class="nav-box-header-right">
							<?php if ( get_theme_mod('wp_shop_woocommerce_header_info_phone') ) : ?><p><i class="fas fa-phone-alt"></i> <?php echo esc_html( get_theme_mod('wp_shop_woocommerce_header_info_phone') ); ?></p><?php endif; ?>
							<?php if ( get_theme_mod('wp_shop_woocommerce_header_info_email') ) : ?><p><i class="fas fa-envelope mail"></i> <?php echo esc_html( get_theme_mod('wp_shop_woocommerce_header_info_email') ); ?></p><?php endif; ?>
						</div>
					</div>
				</div>
			</div>
